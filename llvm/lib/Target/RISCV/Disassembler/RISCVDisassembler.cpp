...
#define TRY_TO_DECODE_FEATURE(FEATURE, DECODER_TABLE, DESC)                    \
  ...
  if ((Bytes[0] & 0x3) == 0x3) {
    ...
    TRY_TO_DECODE(true, DecoderTable64, "RISCV32 table");
