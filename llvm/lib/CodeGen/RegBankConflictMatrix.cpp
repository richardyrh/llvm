...
char RegBankConflictMatrixWrapperLegacy::ID = 0;
INITIALIZE_PASS(RegBankConflictMatrixWrapperLegacy, "reg-bank-conflict-matrix",
...
void RegBankConflictMatrix::init(MachineFunction &MF) {
...
AnalysisKey RegBankConflictMatrixAnalysis::Key;

RegBankConflictMatrix RegBankConflictMatrixAnalysis::run(MachineFunction &MF,
